class Credit extends Phaser.Scene{
    ...
    create(){
        ...
        this.text2 = this.add.bitmapText(game.config.width/2, game.config.height/2 - 100, 'permanent', 'Font: Permanent Marker - Designed by Font Diner https://fonts.google.com/specimen/Permanent+Marker').setOrigin(0.5,0.5).setScale(0.08)
        ...
        this.text3 = this.add.bitmapText(game.config.width/2, game.config.height/2 + 100, 'permanent', 'Movie Music From The 400 Blows by Jean Constantin ie. : Trinite et Finale (From "The 400 Blows") ').setOrigin(0.5,0.5).setScale(0.08)
