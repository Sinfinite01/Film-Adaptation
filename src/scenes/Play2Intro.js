...
//load images
    ...
    create(){
        ...
        this.play2Text7 = this.add.bitmapText(game.config.width/2, game.config.height/2 - 100 , 'permanent', 'Control his eyes as he is sent off in a cop car').setOrigin(0.5, 0.5).setDepth(20).setScale(0.15)
        this.play2Text8 = this.add.bitmapText(game.config.width/2, game.config.height/2 - 75 , 'permanent', 'and looking at the city he has been in his').setOrigin(0.5, 0.5).setDepth(20).setScale(0.15)
